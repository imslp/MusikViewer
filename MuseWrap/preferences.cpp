...
bool useALSA = false, useJACK = false, usePortaudio = false, usePulseAudio = false , useQAudio = false;
...
void Preferences::init()
{
    ...
    QString wd      = QString("%1/%2").arg(QStandardPaths::DocumentsLocation).arg(QCoreApplication::applicationName());
...
PreferenceDialog::PreferenceDialog(QObject* parent)
    : QObject(parent)
{
