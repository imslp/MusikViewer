...
class TestRepeat : public QObject, public MTest
   ...
   private slots:
      ...
      void repeat09() { repeat("repeat09.mscx", "1;2;3;2;5;6"); }                        // 3 voltas
      ...
      void repeat37() { repeat("repeat37.mscx", "1;2;1; 1;2;1; 1;2;1; 1;2;1; 1;2;1"); } // #65161, with section breaks occuring on non-measure frames
