...
//      settings.setValue("synthControlVisible", synthControl && synthControl->isVisible());
      settings.setValue("synthControlVisible", synthControl && true);
      if (mixer)
            mixer->writeSettings();
...
void MuseScore::transpose()
      ...
      cs->transpose(td.mode(), td.direction(), td.transposeKey(), td.transposeInterval(),td.getTransposeKeys(), td.getTransposeChordNames(), td.useDoubleSharpsFlats());
